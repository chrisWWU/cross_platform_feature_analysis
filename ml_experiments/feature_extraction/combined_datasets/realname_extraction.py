...
if __name__ == '__main__':
    ...
    path_to_train = f'../../features/combined_datasets/voc_learned_{init_voc}/realname_train.csv'
    path_to_test = f'../../features/combined_datasets/voc_learned_{init_voc}/realname_test.csv'
