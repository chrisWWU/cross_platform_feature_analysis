...
if __name__ == '__main__':
    ...
    path_to_train = f'../../features/dataset_b/voc_learned_{init_voc}/post_train.csv'
    path_to_test = f'../../features/dataset_b/voc_learned_{init_voc}/post_test.csv'
