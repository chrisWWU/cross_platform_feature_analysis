...
def get_embeddings(path_connect, path_from, path_lookup, flickr):
    ...
    model = models.Node2Vec(G, walk_length=10, num_walks=80, p=0.25, q=4, workers=1)  # init model
...
if __name__ == '__main__':
    ...
    path_to_fl = f'../../../features/{dataset}/friends/node2vec_flickr_core.csv'
    path_to_tw = f'../../../features/{dataset}/friends/node2vec_twitter_core.csv'
    csv = False
