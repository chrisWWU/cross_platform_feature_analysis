...
def merge(user, real, loc, bio, post, pic, friend):
    ...
    user_train = '../../../features/combined_datasets/voc_learned_twitter/username_train.csv'
    user_test = '../../../features/combined_datasets/voc_learned_twitter/username_test.csv'

    real_train = '../../../features/combined_datasets/voc_learned_twitter/realname_train.csv'
    real_test = '../../../features/combined_datasets/voc_learned_twitter/realname_test.csv'

    loc_train = '../../../features/combined_datasets/voc_learned_twitter/location_train.csv'
    loc_test = '../../../features/combined_datasets/voc_learned_twitter/location_test.csv'

    bio_train = '../../../features/combined_datasets/voc_learned_twitter/bio_train.csv'
    bio_test = '../../../features/combined_datasets/voc_learned_twitter/bio_test.csv'

    post_train = '../../../features/combined_datasets/voc_learned_twitter/post_train.csv'
    post_test = '../../../features/combined_datasets/voc_learned_twitter/post_test.csv'

    pic_train = '../../../features/combined_datasets/profilepic_tw.csv'
    pic_test = '../../../features/combined_datasets/profilepic_fl.csv'

    friend_train = '../../../features/combined_datasets/friends/sdne_twitter_core.csv'
    friend_test = '../../../features/combined_datasets/friends/sdne_flickr_core.csv'

    # create initial df with complete labels to merge
    X_train = pd.DataFrame()
    X_test = pd.DataFrame()

    X_train['label'] = pd.read_csv('labels_train.csv', index_col=0)['label']
    X_test['label'] = pd.read_csv('labels_test.csv', index_col=0)['label']
