import itertools
import pandas as pd
#from ml_experiments.ml_execute.combined_datasets_small.twitter_as_training.ml_pipeline import execute_ml
from ml_pipeline import execute_ml
...
def execute_all_combinations():
    ...
    path_to = 'results_twitter_combined_small.csv'
