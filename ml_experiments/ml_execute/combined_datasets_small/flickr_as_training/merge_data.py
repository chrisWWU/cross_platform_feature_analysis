...
def merge(user, real, loc, bio, post, pic, friend):
    ...
    user_train = '../../../features/combined_datasets/voc_learned_flickr/username_train.csv'
    user_test = '../../../features/combined_datasets/voc_learned_flickr/username_test.csv'

    real_train = '../../../features/combined_datasets/voc_learned_flickr/realname_train.csv'
    real_test = '../../../features/combined_datasets/voc_learned_flickr/realname_test.csv'

    loc_train = '../../../features/combined_datasets/voc_learned_flickr/location_train.csv'
    loc_test = '../../../features/combined_datasets/voc_learned_flickr/location_test.csv'

    bio_train = '../../../features/combined_datasets/voc_learned_flickr/bio_train.csv'
    bio_test = '../../../features/combined_datasets/voc_learned_flickr/bio_test.csv'

    post_train = '../../../features/combined_datasets/voc_learned_flickr/post_train.csv'
    post_test = '../../../features/combined_datasets/voc_learned_flickr/post_test.csv'

    pic_train = '../../../features/combined_datasets/profilepic_fl.csv'
    pic_test = '../../../features/combined_datasets/profilepic_tw.csv'

    friend_train = '../../../features/combined_datasets/friends/sdne_flickr_core.csv'
    friend_test = '../../../features/combined_datasets/friends/sdne_twitter_core.csv'
