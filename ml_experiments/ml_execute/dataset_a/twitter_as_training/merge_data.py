...
def merge(user, real, loc, bio, post, pic, friend):
    ...
    user_train = '../../../features/dataset_a/voc_learned_twitter/username_train.csv'
    user_test = '../../../features/dataset_a/voc_learned_twitter/username_test.csv'

    real_train = '../../../features/dataset_a/voc_learned_twitter/realname_train.csv'
    real_test = '../../../features/dataset_a/voc_learned_twitter/realname_test.csv'

    loc_train = '../../../features/dataset_a/voc_learned_twitter/location_train.csv'
    loc_test = '../../../features/dataset_a/voc_learned_twitter/location_test.csv'

    bio_train = '../../../features/dataset_a/voc_learned_twitter/bio_train.csv'
    bio_test = '../../../features/dataset_a/voc_learned_twitter/bio_test.csv'

    post_train = '../../../features/dataset_a/voc_learned_twitter/post_train.csv'
    post_test = '../../../features/dataset_a/voc_learned_twitter/post_test.csv'

    pic_train = '../../../features/dataset_a/profilepic_tw.csv'
    pic_test = '../../../features/dataset_a/profilepic_fl.csv'

    friend_train = '../../../features/dataset_a/friends/sdne_twitter_core.csv'
    friend_test = '../../../features/dataset_a/friends/sdne_flickr_core.csv'
