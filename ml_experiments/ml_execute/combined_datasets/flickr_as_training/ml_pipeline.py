...
from ml_experiments.plot_coefficients import f_importances2
from ml_experiments.ml_execute.combined_datasets.flickr_as_training.merge_data import merge
...
def execute_ml(user, real, loc, bio, post, pic, friend):
    ...
    #f_importances2(abs(clf.coef_[0]), feature_names, top=10)
