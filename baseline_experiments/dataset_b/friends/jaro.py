...
def compare_friends(path_fl, path_tw, path_connect, threshold):
    ...
    print(f'Jaro - Dataset B (threshold = {threshold})')
...
"""
 Jaro - Dataset B (threshold = 0.6)
 8 / 2959
 0.0027036160865157146

 Jaro - Dataset B (threshold = 0.7)
 128 / 2959
 0.04325785738425143

 Jaro - Dataset B (threshold = 0.8)
 550 / 2959
 0.18587360594795538

Jaro - Dataset B (threshold = 0.9)
 484 / 2959
 0.16356877323420074
