...
def bert_bio(path_connection, model, model_name):
    ...
    print(f'SBERT + cosine similarity- Dataset A - Model: {model_name}')
...
if __name__ == '__main__':
    ...
    """
    SBERT - Dataset A - Model: bert-base-nli-mean-tokens
    15 / 65
    0.23076923076923078
    
    
    SBERT - Dataset A - Model: distilbert-base-nli-stsb-mean-tokens
    15 / 65
    0.23076923076923078
    """