...
def whash(path_connection):
    ...
    for i in range(len(fl_paths)):
        ...
        res = [imagehash.whash(Image.open(fl_paths[i])) - imagehash.whash(Image.open(j)) for j in tw_paths]
